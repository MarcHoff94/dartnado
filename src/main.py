...
registered_teams = generate_teams(1, 1, 18)
...
x = SingleKnockOut(registered_teams, Game_Mode(sets_to_win=5, legs_to_win_set=3, points_per_leg=501, check_out= Check_Out.DOUBLE_OUT, check_in= Check_In.STRAIGHT_IN), 0)
print(x.tree)
